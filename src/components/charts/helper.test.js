...
describe('helper', () => {
  ...
  it('returns chart data as expected', () => {
    expect(helper.transformArrangerDataToChart(ethnicityFieldJSON, noSelectSqonValues)).toEqual(
      ethnicityChartData,
    );
    expect(helper.transformArrangerDataToChart(ethnicityFieldJSON, selectWhiteSqonValues)).toEqual(
      ethnicityChartDataWithOnlyWhiteSelected,
    );
  });

  it('returns count data as expected', () => {
    expect(
      helper.transformDataToCount(ethnicityFieldJSON, 'Ethnicity', noSelectSqonValues),
    ).toEqual(ethnicityCountData);
    expect(
      helper.transformDataToCount(ethnicityFieldJSON, 'Ethnicity', selectWhiteSqonValues),
